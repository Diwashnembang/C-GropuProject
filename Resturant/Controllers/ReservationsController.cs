...
namespace Resturant.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public ReservationsController(ResturantContext context)
        {
            _context = context;
        }
        ...
        {
            var resturantContext = _context.Reservation.Include(r => r.Customer);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Date,Time,NoOfPeople,TabelNo,CustomerId")] Reservation reservation)
        {
